            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-slate-700 border border-slate-600 rounded text-white placeholder-slate-500 focus:outline-none focus:border-yellow-500"
                  rows={4}
                />
              </div>
              ...
              <button
                onClick={handleReply}
                disabled={!reply.trim()}
                className="bg-yellow-600 hover:bg-yellow-700 disabled:bg-slate-600 text-white px-6 py-2 rounded"
              >
                Send Reply
              </button>
            </div>
